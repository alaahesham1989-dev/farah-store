...
const Cart = (() => {
  ...
  function prepareOrderPayload(customerData) {
    ...
    return {
      ...
      paymentStatus:   (customerData.paymentMethod === 'vodafone_cash' || customerData.paymentMethod === 'instapay') ? 'pending_verification' : 'pending',
      status:          (customerData.paymentMethod === 'vodafone_cash' || customerData.paymentMethod === 'instapay') ? 'pending_payment' : 'new',
