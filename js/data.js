...
const PRODUCTS = [
  ...
  },
  {
    ...
    "category": "العناية بالبشرة",
    "description": "<ul class=\"product-features-list\" style=\"list-style:disc; padding-right:20px; line-height:1.8;\"><li><strong>نظرة عامة:</strong> قلم ديرما بن احترافي لتجديد خلايا البشرة وتحفيز الكولاجين..</li><li><strong>التفاصيل:</strong> قلم ديرما بن احترافي لتجديد خلايا البشرة وتحفيز الكولاجين، يأتي مع إبر غيار لنتائج مثالية.</li></ul>",
